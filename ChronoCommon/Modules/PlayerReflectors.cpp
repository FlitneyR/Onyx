...
using PlayerController = chrono::Player::PlayerController;
using Projectile = chrono::Player::Projectile;
...
void chrono::Player::RegisterReflectors( onyx::ecs::ComponentReflectorTable& table )
{
